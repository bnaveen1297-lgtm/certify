      ...
      <div className="p-3">
        <div className="flex items-center justify-between mb-2">
          ...
          {template.elements.length > 0 && (
            <button
              onClick={() => {
                // Delete selected element, or show hint
                if (selectedId) onRemoveElement(selectedId)
              }}
              className="text-[9px] text-white/30 hover:text-red-400 transition-colors px-1.5 py-0.5 rounded border border-white/10 hover:border-red-400/30"
              title="Delete selected element (or click element trash icon)"
            >
              Del selected
            </button>
          )}
            ...
            return (
              <div
                ...
                className={[
                  ...
                  isSelected ? "bg-blue-500/15 border border-blue-500/40" : "hover:bg-white/5 border border-transparent",
