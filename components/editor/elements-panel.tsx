    ...
    <div className="flex flex-col">
      ...
      <div className="p-3">
        ...
        {template.elements.length === 0 && (
          <p className="text-[11px] text-white/20 text-center py-4">No elements. Add some above.</p>
        )}
          ...
          {sorted.map((el, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Action buttons — always visible, red trash icon for clarity */}
                <div className="flex items-center gap-0.5 shrink-0">
                  ...
                  <button
                    ...
                    className="w-5 h-5 flex items-center justify-center text-red-400/70 hover:text-red-400 rounded"
                    title="Delete"
                  >
                    <Trash2 size={10} />
                  </button>
